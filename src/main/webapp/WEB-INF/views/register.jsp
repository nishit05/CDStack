...
<body>
	...
	<div class="container">
		...
		<form:form action="${pageContext.request.contextPath}/addcustomer"
			...
			<font size="5" style="font-weight: bold;"><form:errors path="name" cssStyle="color:maroon" ></form:errors></font>
			<br>

			<form:label path="email" cssClass="control-label col-sm-4"
				cssStyle="font-size: 25px">E-mail</form:label>
			<form:input path="email" cssClass="form-control" />
			<font size="5" style="font-weight: bold;"><form:errors path="email" cssStyle="color:maroon"></form:errors></font>
			<br>

			<form:label path="username" cssClass="control-label col-sm-4"
				cssStyle="font-size: 25px">Username</form:label>
			<form:input path="username" cssClass="form-control" />
			<font size="5" style="font-weight: bold;"><form:errors path="username" cssStyle="color:maroon"></form:errors></font>
			<br>

			<form:label path="password" cssClass="control-label col-sm-4"
				cssStyle="font-size: 25px">Password</form:label>
			<form:password path="password" cssClass="form-control" />
			<font size="5" style="font-weight: bold;"><form:errors path="password" cssStyle="color:maroon"></form:errors></font>
			<br>
			...
			<font size="5" style="font-weight: bold;"><form:errors path="cpass" cssStyle="color:maroon"></form:errors></font>
			<br>
